...
$invoice_date = date('d-m-Y', strtotime($bill['invoice_date']));
$filename_date = date('Y.m.d', strtotime($bill['invoice_date']));
...
<head>
    ...
    <title>Tax Invoice - <?php echo htmlspecialchars($bill['invoice_number']); ?></title>
...
<body>
    ...
    <div class="top-actions" style="text-align:right;margin-bottom:10px;">
        <button class="action-btn print-btn" onclick="printBill()">🖨️ Print</button>
        <button class="action-btn new-btn" onclick="window.location.href='bill_form.php'">➕ Create New Bill</button>
    </div>
    ...
    <div class="page">
        <div class="main-box">
                ...
                <tr>
                    <td>
                        ...
                        <div class="party-body">
                            ...
                            <div class="pb-row">
                                ...
                                <span class="pb-value"><?php echo htmlspecialchars($bill['buyer_name']); ?></span>
                            </div>

                            <div class="pb-row">
                                <span class="pb-label">ADDRESS:</span>
                                <span
                                    class="pb-value"><?php echo nl2br(htmlspecialchars($bill['buyer_address'])); ?></span>
                            </div>

                            <div class="pb-row">
                                <span class="pb-label">MOBILE:</span>
                                <span class="pb-value"><?php echo htmlspecialchars($bill['buyer_mobile']); ?></span>
                            </div>

                            <div class="pb-row">
                                <span class="pb-label">GSTIN:</span>
                                <span class="pb-value"><?php echo htmlspecialchars($bill['buyer_gst']); ?></span>
                            </div>

                            <div class="pb-row">
                                <span class="pb-label">STATE:</span>
                                <span class="pb-value"><?php echo htmlspecialchars($bill['buyer_state']); ?></span>
                            </div>
                    ...
                    <td>
                        ...
                        <div class="party-body">
                            ...
                            <div class="pb-row">
                                <span class="pb-label">NAME:</span>
                                <span class="pb-value"><?php echo htmlspecialchars($bill['consignee_name']); ?></span>
                            </div>

                            <div class="pb-row">
                                <span class="pb-label">ADDRESS:</span>
                                <span
                                    class="pb-value"><?php echo nl2br(htmlspecialchars($bill['consignee_address'])); ?></span>
                            </div>

                            <div class="pb-row">
                                <span class="pb-label">MOBILE:</span>
                                <span class="pb-value"><?php echo htmlspecialchars($bill['consignee_mobile']); ?></span>
                            </div>

                            <div class="pb-row">
                                <span class="pb-label">GSTIN:</span>
                                <span class="pb-value"><?php echo htmlspecialchars($bill['consignee_gst']); ?></span>
                            </div>

                            <div class="pb-row">
                                <span class="pb-label">STATE:</span>
                                <span class="pb-value"><?php echo htmlspecialchars($bill['consignee_state']); ?></span>
                            </div>
            ...
            <table class="totals-table">
                ...
                <?php if($bill['tax_type']=="SGST/CGST"): ?>
                <?php if($bill['cgst_amount']>0): ?>
                <tr>
                    <td>CGST</td>
                    <td>₹ <?php echo number_format($bill['cgst_amount'],2); ?></td>
                </tr>
                <?php endif; ?>
                <?php if($bill['sgst_amount']>0): ?>
                <tr>
                    <td>SGST</td>
                    <td>₹ <?php echo number_format($bill['sgst_amount'],2); ?></td>
                </tr>
                <?php endif; ?>
                <?php else: ?>
                <?php if($bill['igst_amount']>0): ?>
                <tr>
                    <td>IGST</td>
                    <td>₹ <?php echo number_format($bill['igst_amount'],2); ?></td>
                </tr>
                <?php endif; ?>
                <?php endif; ?>

                <?php if($bill['freight']>0): ?>
                <tr>
                    <td>Freight</td>
                    <td>₹ <?php echo number_format($bill['freight'],2); ?></td>
                </tr>
                <?php endif; ?>

                <?php if($bill['rounding_adjustment']!=0): ?>
                <tr>
                    <td>Round Off</td>
                    <td>₹ <?php echo number_format($bill['rounding_adjustment'],2); ?></td>
                </tr>
                <?php endif; ?>
            ...
            <div class="amount-words">
                <?php echo htmlspecialchars($bill['amount_in_words']); ?>
            </div>
            ...
            <table class="footer-table">
                <tr>
                    <td>
                        <h3><strong>Bank Details:</strong><br></h3>
                        Bank: <?php echo $bill['bank_name']; ?><br>
                        A/C: <?php echo $bill['bank_account']; ?><br>
                        IFSC: <?php echo $bill['bank_ifsc']; ?><br>
                        <?php echo $bill['bank_branch']; ?>
                    </td>
                    <td>
    ...
    async function printBill() {
        ...
        const amount = '<?php echo number_format($bill['grand_total'], 0, '', ''); ?>';
        const company = '<?php echo htmlspecialchars($bill['buyer_name']); ?>';
        const filename = date + '_RS.' + amount + '_' + company + '.pdf';

        const billElement = document.querySelector('.page');
